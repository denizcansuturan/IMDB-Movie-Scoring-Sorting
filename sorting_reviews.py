...
def wilson_lower_bound(up, down, confidence=0.95):
    ...
    Note:
    If the scores are between 1-5, 1-3 are marked negative and 4-5 positive, and can be made suitable for Bernoulli.
    However, this brings some problems along with it. Therefore, it is necessary to make a Bayesian average rating."
    Parameters
    ----------
    up: int
        up count
