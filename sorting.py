...
# now every factor is on the same scale
...
############################################
# Practice: IMDB Movie Scoring & Sorting
############################################
...
# according to vote_count describe
# did not work
...
df.sort_values("weighted_rating", ascending=False).head(8)
df.head()
